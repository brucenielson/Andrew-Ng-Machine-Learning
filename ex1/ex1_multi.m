...
[thetax, J2] = gradientDescentMulti(X, y, [0; 0; 0], 0.03, num_iters);
[thetax, J3] = gradientDescentMulti(X, y, [0; 0; 0], 0.1, num_iters);
[thetax, J4] = gradientDescentMulti(X, y, [0; 0; 0], 0.3, num_iters);
[thetax, J5] = gradientDescentMulti(X, y, [0; 0; 0], 1, num_iters);
